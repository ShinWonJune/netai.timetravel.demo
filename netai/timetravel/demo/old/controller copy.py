            ...
            for pattern in patterns:
                for i in range(20):
                    ...
                    if prim and prim.IsValid():
                        ...
                        if len(real_paths) >= 24:  # 필요한 수만큼만 찾음
                            break
    ...
    def _create_temporary_mapping(self):
        ...
        if self._rack_paths and sensor_ids:
            ...
            if not self._rack_paths:
                print("[netai.timetravel.demo] 랙 경로가 없음!")
            if not sensor_ids:
                print("[netai.timetravel.demo] 센서 ID가 없음!")
